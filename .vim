...
" java compiler {{{
function! CompilerJava()
	execute 'w'
	let compilerDir = ' e:\Java\code\classes\'
	let encode = ' -encoding utf-8'		" compiler encode
	execute '!javac -d'.compilerDir. encode.' %'
endfunction
" java compiler short key
map <Leader>j <ESC>:call CompilerJava()<CR>
" }}}

" open cmd {{{
function! StartCmd()
	execute 'cd E:\Software Design & Development\Assembly Language\Code'
	execute '!cmd'
endfunction
" open Windowns command terminal
map <leader>m <ESC>:call StartCmd()<CR>
" }}}
